...
class DataException(TException):
    ...
    def __init__(self, message=None, callStack=None, date=None,):
        super(DataException, self).__setattr__('message', message)
        super(DataException, self).__setattr__('callStack', callStack)
        super(DataException, self).__setattr__('date', date)
    ...
    def __hash__(self):
        return hash(self.__class__) ^ hash((self.message, self.callStack, self.date, ))
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    callStack = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    date = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
