...
public class CalciteTranslate {
  public static void main(String[] args) throws SqlParseException, ValidationException, RelConversionException, SQLException {
    ...
    ReflectiveSchema schema = new ReflectiveSchema(new CalciteTranslate());
    ...
    SqlNode sqlNode = planner.parse("SELECT translate('AaBbCc', 'abc', '123')");
