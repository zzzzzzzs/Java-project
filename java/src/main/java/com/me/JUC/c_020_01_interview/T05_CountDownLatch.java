...
public class T05_CountDownLatch {
    ...
    // 单个countdownlatch 会导致输出上出现问题
    public static void main(String[] args) {
        T05_CountDownLatch c = new T05_CountDownLatch();
        CountDownLatch latchForT1 = new CountDownLatch(1);
        CountDownLatch latchForT2 = new CountDownLatch(1);
